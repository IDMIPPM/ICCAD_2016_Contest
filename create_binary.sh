...
cd abc
make clean
make libabc.a OPTFLAGS="-g -O3" RELEASE=1 ABC_USE_NO_READLINE=1
cp libabc.a ../fim
...
cd ../fim
rm ./equiv.exe
gcc -O3 -fopenmp -o equiv.exe fim_generate_final_faults.o fim_misc.o fim_ntk_circuits_generator.o fim_obvious_pairs.o fim_pregroup_faults_generator.o fim_read_and_preprocess.o fim_write_result_in_file.o main.o libabc.a -lm -ldl -rdynamic -ltermcap -lpthread -lrt
cp ./equiv.exe ../
